...
type PublicAuthSetting struct {
	...
	AllowPasswordRegister bool                    `json:"allowPasswordRegister"`
...
// RegisterCreditsSetting 注册初始算力点配置。
type RegisterCreditsSetting struct {
...
type PrivateSetting struct {
	...
	RegisterCredits RegisterCreditsSetting `json:"registerCredits"`
}
